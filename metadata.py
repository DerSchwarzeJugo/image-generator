...
def main():
	ipfsHash = input("Provide the IPFS hash of the folder containing the images: ")
	...
	manipulatedData = manipulateData(loadedData, ipfsHash)
...
def manipulateData(data, ipfsHash):
	result = []
	for item in data:
		obj = {
			"name": item["name"],
